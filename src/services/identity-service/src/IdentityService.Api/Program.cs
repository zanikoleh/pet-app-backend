...
builder.AddStructuredLogging("identity-service");
...
{
    scope.ServiceProvider.GetRequiredService<IdentityService.Infrastructure.Persistence.IdentityServiceDbContext>().Database.Migrate();
}

app.Run();

#pragma warning disable CS1591
namespace IdentityService.Api { public class IdentityApiMarker { } }
